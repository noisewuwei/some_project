...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions {
    ...
    [ZJVersionCheck updateVisonWithWindow:self.window AppId:App_Id];
...
-(void)registerAPPPay{
    //向微信注册wxde06caa10050b707
    [WXApi registerApp:WX_APPID];
    
    //注册百度移动统计
    [[BaiduMobStat defaultStat] startWithAppId:BaiduMob_APP_KEY];
          ...
          onConfiguration:^(SSDKPlatformType platformType, NSMutableDictionary *appInfo)
     {
         ...
         switch (platformType)
         {
             ...
             case SSDKPlatformTypeWechat:
                 ...
                 break;
             case SSDKPlatformTypeQQ:
                 [appInfo SSDKSetupQQByAppId:Tencent_APPID
                                      appKey:Tencent_APPKEY
                                    authType:SSDKAuthTypeBoth];
                 break;
