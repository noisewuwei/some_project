...
//  Owner
//
//  Created by Jion on 15/12/14.
//  Copyright © 2015年 Youjuke. All rights reserved.
//

#import "ZJVersionCheck.h"

//系统版本
#define zSystemVersion [[[UIDevice currentDevice] systemVersion] floatValue]
#define APP_URL   @"https://itunes.apple.com/lookup?id=%@"  //1071510381

@interface ZJVersionCheck ()<UIAlertViewDelegate>
@property(nonatomic,copy)NSString *downLoadUrl;

@end

@implementation ZJVersionCheck

+ (void)updateVisonWithWindow:(UIWindow*)window AppId:(NSString*)appId
{
    
    ZJVersionCheck *check = [[ZJVersionCheck alloc] init];
