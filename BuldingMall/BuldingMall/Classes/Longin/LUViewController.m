...
@interface LUViewController ()<UITextFieldDelegate>
...
- (void)viewDidLoad {
    ...
    UILabel *toplabel = [[UILabel alloc]initWithFrame:CGRectMake(15, 87, zScreenWidth, 15)];
    toplabel.text = @"关联已有优居客账号";
    toplabel.font = [UIFont systemFontOfSize:14];
    toplabel.textColor = [UIColor colorHexString:@"999999"];
    [self.view addSubview:toplabel];
    
    _numText = [[UITextField alloc]initWithFrame:CGRectMake(15, 87+35, self.view.bounds.size.width-30, 50)];
    _passText = [[UITextField alloc]initWithFrame:CGRectMake(15, 87+50+35, self.view.bounds.size.width-30, 50)];
    _verifyButton = [[UIButton alloc]initWithFrame:CGRectMake(_numText.bounds.size.width-105, 64+23+10+35, 105, 30)];
    ...
    UILabel *downlabel = [[UILabel alloc]initWithFrame:CGRectMake(15, 87+100+18+10+20, zScreenWidth, 15)];
    downlabel.text = @"关联后,您的第三方帐号和优居客账户都可以登录";
    downlabel.font = [UIFont systemFontOfSize:14];
    downlabel.textColor = [UIColor colorHexString:@"999999"];
    [self.view addSubview:downlabel];
    
    _loginButton = [[UIButton alloc]initWithFrame:CGRectMake(15, 87+100+18+35+25, self.view.bounds.size.width-30, 48)];
    ...
    UILabel *labelfront = [[UILabel alloc]initWithFrame:CGRectMake(30, 280+35+15, 150, 30)];
    ...
    _buttonbeh = [[UIButton alloc]initWithFrame:CGRectMake(180, 280+35+15, 120, 30)];
...
//http://prebk.youjuke.com/api/set_malluser
-(void)back{
    [self dismissViewControllerAnimated:YES completion:^{
        NSLog(@"取消登录");
    }];
