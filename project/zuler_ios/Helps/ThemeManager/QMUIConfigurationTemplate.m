...
- (void)applyConfigurationTemplate {
    ...
    QMUICMI.buttonTintColor = [UIColor qmui_colorWithHexString:@"#DE733A"];                                      // ButtonTintColor : QMUIButton 默认的 tintColor，不影响系统的 UIButton
    ...
    QMUICMI.navBarTintColor = [UIColor qmui_colorWithHexString:@"#181818"];                                              // NavBarTintColor : NavBarContainerClasses 里的 UINavigationBar 的 tintColor，也即导航栏上面的按钮颜色
